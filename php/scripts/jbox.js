...
jQuery(document).ready(function(){
	...
	if (jumpBox.twitterUsername!="") {
		...
		$.getJSON("http://api.twitter.com/1/statuses/user_timeline.json?screen_name="+jumpBox.twitterUsername+"&count="+jumpBox.numberOfTweets+"&include_entities=true&callback=?",
			function(tweetdata) {
